...
| Level 01 scene | In progress — C1–C3 + P1–P3 verified (2026-06-01); **P4** corridor + C4 pending ([GAME_CONCEPT.md](docs/GAME_CONCEPT.md#11-level01--detailed-level-design-approved), [SETUP.md](SETUP.md)) |
